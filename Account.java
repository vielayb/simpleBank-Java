...
public class Account {
    ...
    void calculateInterest(int years) {
        ...
        System.out.println("The current interest reate is " + (100 * interestRate) + "%");
    ...
    void showMenu() {
        ...
        do {
            ...
            switch(option) {
                ...
                default:
                System.out.println("Error: invalid option. Pease enter A, B, C, D, E, F");
                break;
            }
        } while(option != 'F');
        System.out.println("Thannk you for banking with us!");
    }
